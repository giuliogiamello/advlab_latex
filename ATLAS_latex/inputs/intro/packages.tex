...
% caption: to have i.e. 'Figure 1.5' in bold
...
% titlesec: to move up in the pace and center the chapter title
\usepackage{titlesec}
...
% Adjust chapter header spacing
\begin{comment}
\titleformat{\chapter}[display]
    {\normalfont\bfseries\Huge}
    {\filcenter\chaptertitlename\ \thechapter} % Chapter number format
    {15pt} % Space between number and title (positive value prevents overlap)
    {\Huge\filcenter} % Title format
\titlespacing*{\chapter}
    {0pt} % Left margin
    {-40pt} % Vertical space before header (negative moves it up)
    {30pt} % Vertical space after title
...
\titlespacing*{\chapter}
    {0pt} % Left margin
    {-40pt} % Vertical space before header (negative moves it up)
    {10pt} % Vertical space after title
\end{comment}
